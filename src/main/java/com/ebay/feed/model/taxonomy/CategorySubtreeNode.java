 ...
 *
 */
public class CategorySubtreeNode {
  ...
  private CategorySubtreeNode[] childCategoryTreeNodes;
  ...
  public CategorySubtreeNode[] getChildCategoryTreeNodes() {
    return childCategoryTreeNodes;
  }

  public void setChildCategoryTreeNodes(CategorySubtreeNode[] childCategoryTreeNodes) {
    this.childCategoryTreeNodes = childCategoryTreeNodes;
  }

  @Override
  public String toString() {
    return "ClassPojo [category = " + category + ", categoryTreeNodeLevel = "
        + categoryTreeNodeLevel + ", parentCategoryTreeNodeHref = " + parentCategoryTreeNodeHref
